...
namespace Restaurant.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="id,Name,Description,CreatedDate")] ItemCategory itemcategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="id,Name,Description,CreatedDate")] ItemCategory itemcategory)
        {
            if (ModelState.IsValid)
            {
